#!/usr/bin/env bash
# Train the v2 TinyStories ELF-B model (authors' hyperparameters, 50k stories).
set -euo pipefail
cd "$(dirname "$0")/.."
...
exec python3 src/train.py --config tinystories_demo/train_tinystories_ELF-B_v2.yml "$@"
